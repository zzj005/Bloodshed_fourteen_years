...
NMilitary = {
	...
	SUPPLY_GRACE = 96,							   -- troops always carry 3 days of food and supply
	...
	SUPPLY_ORG_MAX_CAP = 0.45,                     -- Max organization is factored by this if completely out of supply
	...
	OUT_OF_SUPPLY_SPEED = -0.7,                    -- max speed reduction from supply
	...
	BORDER_WAR_VICTORY = 1.5,					   -- At wich border war balance of power is victory declared
	...
	MIN_DIVISION_DEPLOYMENT_TRAINING = 0.5,			-- Min level of division training
...
NAI = {
	...
	DEPLOY_MIN_TRAINING_PEACE_FACTOR = 0.90,        -- Required percentage of training (1.0 = 100%) for AI to deploy unit in peacetime
	DEPLOY_MIN_EQUIPMENT_PEACE_FACTOR = 0.90,       -- Required percentage of equipment (1.0 = 100%) for AI to deploy unit in peacetime
	DEPLOY_MIN_TRAINING_WAR_FACTOR = 0.85,          -- Required percentage of training (1.0 = 100%) for AI to deploy unit in wartime
	...
	PLAN_ATTACK_MIN_ORG_FACTOR_MED = 0.6,		-- (LOW,MED,HIGH) corresponds to the plan execution agressiveness level.
	...
	START_TRAINING_EQUIPMENT_LEVEL = 0.55,               -- ai will not start to train if equipment drops below this level
	STOP_TRAINING_EQUIPMENT_LEVEL = 0.50,                -- ai will not train if equipment drops below this level
